          ...
          <div>
            ...
            <div className='flex gap-1'>
              <p className='text-muted-foreground'>
                Manage clinicians, coordinators, and their access levels here.
              </p>
              <LearnMore
                open={opened}
              ...
              >
                ...
                <p className='mt-4'>
                  ...
                  clinician profile menu in the top-right corner of the page.
          ...
          <sup>
            <LearnMore open={opened} onOpenChange={setOpened}>
              ...
              <p className='mt-4'>
                ...
                account via the clinician profile dropdown on this page.
              </p>
            </LearnMore>
          </sup>
          <br />
